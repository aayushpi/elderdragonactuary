...
import type { MtgColor, ScryfallCard } from "@/types"

export const badgeVariants = cva(
  "inline-flex items-center rounded-md border px-3 py-1 text-sm font-medium transition-colors focus:outline-none focus:ring-2 focus:ring-ring focus:ring-offset-2",
  {
    variants: {
      variant: {
        default:
