...
export function MapPage({ games }: MapPageProps) {
  return (
    <div className="space-y-2">
      <h1 className="text-lg font-semibold">Commander Stats</h1>
      <p className="text-sm text-muted-foreground">This page shows commander statistics and related visualizations.</p>
      <p className="text-xs text-muted-foreground">Games in dataset: {games.length}</p>
    </div>
  )
}
...
export function MapPage({ games }: MapPageProps) {
  return (
    <div className="space-y-2">
      ...
      <p className="text-xs text-muted-foreground">Loaded games: {games.length}</p>
    </div>
  )
}
